...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MerchantAccount.region'
        db.add_column('oscar_mws_merchantaccount', 'region',
                      self.gf('django.db.models.fields.CharField')(default='US', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MerchantAccount.region'
        db.delete_column('oscar_mws_merchantaccount', 'region')
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'device_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'products'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'valid_users': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'products_can_purchase'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"})
        },
        ...
        'order.line': {
            ...
            'payment_plan': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['order.PaymentPlan']", 'null': 'True', 'blank': 'True'}),
            ...
            'shipping_address': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'order_lines'", 'null': 'True', 'to': "orm['order.ShippingAddress']"}),
            'shipping_addresses': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'order_lines_multiple'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['order.ShippingAddress']"}),
        ...
        'order.paymentplan': {
            ...
            'cancellation_penalty': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'pay_for_device': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'prepay_service': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'prepay_service_months': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'price_amount': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '12', 'decimal_places': '2'}),
            'price_currency': ('django.db.models.fields.CharField', [], {'default': "'USD'", 'max_length': '12'}),
            'redeem_coupon': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'redeem_coupon_months': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'return_device': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sign_contract': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sign_contract_months': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'start_payment_period': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'start_payment_period_months': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
        },
