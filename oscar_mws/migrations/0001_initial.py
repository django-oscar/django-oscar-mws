...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('oscar_mws_feedsubmission', (
            ...
            ('processing_status', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        ...
        db.create_table('oscar_mws_feedreport', (
            ...
            ('warnings', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('oscar_mws', ['FeedReport'])

        # Adding model 'FeedResult'
        db.create_table('oscar_mws_feedresult', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message_code', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('feed_report', self.gf('django.db.models.fields.related.ForeignKey')(related_name='results', to=orm['oscar_mws.FeedReport'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['catalogue.Product'])),
        ))
        db.send_create_signal('oscar_mws', ['FeedResult'])

        # Adding model 'AmazonProfile'
        db.create_table('oscar_mws_amazonprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('asin', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('product', self.gf('django.db.models.fields.related.OneToOneField')(related_name='amazon_profile', unique=True, to=orm['catalogue.Product'])),
            ('product_tax_code', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ...
        db.create_table('oscar_mws_fulfillmentorder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fulfillment_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='outbound_shipments', to=orm['order.Order'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('oscar_mws', ['FulfillmentOrder'])

        # Adding model 'FulfillmentOrderLine'
        db.create_table('oscar_mws_fulfillmentorderline', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('line', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fulfillment_lines', to=orm['order.Line'])),
            ('fulfillment_order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oscar_mws.FulfillmentOrder'])),
            ('order_item_id', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('oscar_mws', ['FulfillmentOrderLine'])

        # Adding model 'FulfillmentShipment'
        db.create_table('oscar_mws_fulfillmentshipment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shipment_id', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('fulfillment_center_id', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fulfillment_shipments', to=orm['order.Order'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=24)),
            ('date_estimated_arrival', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('date_shipped', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('oscar_mws', ['FulfillmentShipment'])

        # Adding M2M table for field shipment_events on 'FulfillmentShipment'
        db.create_table('oscar_mws_fulfillmentshipment_shipment_events', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fulfillmentshipment', models.ForeignKey(orm['oscar_mws.fulfillmentshipment'], null=False)),
            ('shippingevent', models.ForeignKey(orm['order.shippingevent'], null=False))
        ))
        db.create_unique('oscar_mws_fulfillmentshipment_shipment_events', ['fulfillmentshipment_id', 'shippingevent_id'])

        # Adding model 'ShipmentPackage'
        db.create_table('oscar_mws_shipmentpackage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tracking_number', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('carrier_code', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('fulfillment_shipment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='packages', to=orm['oscar_mws.FulfillmentShipment'])),
        ))
        db.send_create_signal('oscar_mws', ['ShipmentPackage'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FeedResult'
        db.delete_table('oscar_mws_feedresult')
        ...
        # Deleting model 'FulfillmentOrderLine'
        db.delete_table('oscar_mws_fulfillmentorderline')

        # Deleting model 'FulfillmentShipment'
        db.delete_table('oscar_mws_fulfillmentshipment')

        # Removing M2M table for field shipment_events on 'FulfillmentShipment'
        db.delete_table('oscar_mws_fulfillmentshipment_shipment_events')

        # Deleting model 'ShipmentPackage'
        db.delete_table('oscar_mws_shipmentpackage')
    ...
    models = {
        ...
        'oscar_mws.fulfillmentorder': {
            ...
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'outbound_shipments'", 'to': "orm['order.Order']"}),
        ...
        'oscar_mws.fulfillmentorderline': {
            ...
            'fulfillment_order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['oscar_mws.FulfillmentOrder']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'line': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fulfillment_lines'", 'to': "orm['order.Line']"}),
