...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MerchantAccount.partner'
        db.add_column('oscar_mws_merchantaccount', 'partner',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='amazon_merchant', unique=True, null=True, to=orm['partner.Partner']),
                      keep_default=False)

        # Adding field 'AmazonProfile.sku'
        db.add_column('oscar_mws_amazonprofile', 'sku',
                      self.gf('django.db.models.fields.CharField')(default='UNSPECIFIED SKU', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MerchantAccount.partner'
        db.delete_column('oscar_mws_merchantaccount', 'partner_id')

        # Deleting field 'AmazonProfile.sku'
        db.delete_column('oscar_mws_amazonprofile', 'sku')
