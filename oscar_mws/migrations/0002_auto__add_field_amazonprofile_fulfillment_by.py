...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AmazonProfile.fulfillment_by'
        db.add_column('oscar_mws_amazonprofile', 'fulfillment_by',
                      self.gf('django.db.models.fields.CharField')(default='FBM', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AmazonProfile.fulfillment_by'
        db.delete_column('oscar_mws_amazonprofile', 'fulfillment_by')
    ...
    models = {
        ...
        'oscar_mws.amazonprofile': {
            ...
            'fulfillment_by': ('django.db.models.fields.CharField', [], {'default': "'FBM'", 'max_length': '3'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
