...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FulfillmentOrder.shipping_address'
        db.add_column('oscar_mws_fulfillmentorder', 'shipping_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='fulfillment_orders', null=True, to=orm['order.ShippingAddress']),
                      keep_default=False)

        # Adding field 'FulfillmentOrder.shipping_speed'
        db.add_column('oscar_mws_fulfillmentorder', 'shipping_speed',
                      self.gf('django.db.models.fields.CharField')(default='Standard', max_length=200),
                      keep_default=False)

        # Adding field 'FulfillmentOrder.comments'
        db.add_column('oscar_mws_fulfillmentorder', 'comments',
                      self.gf('django.db.models.fields.TextField')(default='Thanks'),
                      keep_default=False)

        # Adding field 'FulfillmentOrderLine.quantity'
        db.add_column('oscar_mws_fulfillmentorderline', 'quantity',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'FulfillmentOrderLine.price_incl_tax'
        db.add_column('oscar_mws_fulfillmentorderline', 'price_incl_tax',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3, blank=True),
                      keep_default=False)

        # Adding field 'FulfillmentOrderLine.comment'
        db.add_column('oscar_mws_fulfillmentorderline', 'comment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FulfillmentOrder.shipping_address'
        db.delete_column('oscar_mws_fulfillmentorder', 'shipping_address_id')

        # Deleting field 'FulfillmentOrder.shipping_speed'
        db.delete_column('oscar_mws_fulfillmentorder', 'shipping_speed')

        # Deleting field 'FulfillmentOrder.comments'
        db.delete_column('oscar_mws_fulfillmentorder', 'comments')

        # Deleting field 'FulfillmentOrderLine.quantity'
        db.delete_column('oscar_mws_fulfillmentorderline', 'quantity')

        # Deleting field 'FulfillmentOrderLine.price_incl_tax'
        db.delete_column('oscar_mws_fulfillmentorderline', 'price_incl_tax')

        # Deleting field 'FulfillmentOrderLine.comment'
        db.delete_column('oscar_mws_fulfillmentorderline', 'comment')
    ...
    models = {
        ...
        'oscar_mws.amazonmarketplace': {
            'Meta': {'object_name': 'AmazonMarketplace'},
        ...
        'oscar_mws.amazonprofile': {
            ...
            'marketplaces': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'amazon_profiles'", 'symmetrical': 'False', 'to': "orm['oscar_mws.AmazonMarketplace']"}),
        ...
        'oscar_mws.feedsubmission': {
            ...
            'feed_xml': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'oscar_mws.fulfillmentorder': {
            ...
            'shipping_address': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fulfillment_orders'", 'null': 'True', 'to': "orm['order.ShippingAddress']"}),
            'shipping_speed': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'UNSUBMITTED'", 'max_length': '25', 'blank': 'True'})
        },
        'oscar_mws.fulfillmentorderline': {
            ...
            'price_incl_tax': ('django.db.models.fields.CharField', [], {'max_length': '3', 'blank': 'True'}),
            'quantity': ('django.db.models.fields.PositiveIntegerField', [], {}),
        ...
        'oscar_mws.merchantaccount': {
            'Meta': {'unique_together': "(('aws_api_key', 'aws_api_secret', 'seller_id'),)", 'object_name': 'MerchantAccount'},
            'aws_api_key': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'aws_api_secret': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'partner': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'amazon_merchant'", 'unique': 'True', 'null': 'True', 'to': "orm['partner.Partner']"}),
            'region': ('django.db.models.fields.CharField', [], {'default': "'US'", 'max_length': '2'}),
            'seller_id': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
